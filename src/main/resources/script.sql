...
INSERT INTO "TEST"."BANK_CONTACT" (BANK_ID, NAME, POSITION_TYPE) VALUES ('1', 'Test Name', 'MANAGER');
INSERT INTO "TEST"."BANK_CONTACT" (BANK_ID, NAME, POSITION_TYPE) VALUES ('2', 'Test name 2', 'DEVELOPER');
...
INSERT INTO "TEST"."FINANCES_USER" (USER_ID, FIRST_NAME, LAST_NAME, BIRTH_DATE, EMAIL_ADDRESS, LAST_UPDATED_BY, LAST_UPDATED_DATE, CREATED_BY, CREATED_DATE) VALUES ('1', 'Jarek', 'Rola', TO_DATE('90/08/31', 'RR/MM/DD'), 'jaroslaw.rola@jrola.pl', 'SYSTEM', TO_DATE('15/12/25', 'RR/MM/DD'), 'SYSTEM', TO_DATE('15/12/25', 'RR/MM/DD'))
